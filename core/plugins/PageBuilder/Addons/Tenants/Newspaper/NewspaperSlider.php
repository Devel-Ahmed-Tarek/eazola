...
class NewspaperSlider extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Newspaper/slider.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.newspaper.slider',$data);
