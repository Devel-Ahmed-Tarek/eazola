...
------------------------------*/
   ...
   -------------------------------------------- */
    Route::prefix('media-upload')->controller(\App\Http\Controllers\Landlord\Admin\MediaUploaderController::class)->group(function () {
        Route::post('/delete', 'delete_upload_media_file')->name('tenant.user.upload.media.file.delete');
        Route::get('/page', 'all_upload_media_images_for_page')->name('tenant.user.upload.media.images.page');
        Route::post('/alt', 'alt_change_upload_media_file')->name('tenant.user.upload.media.file.alt.change');
    });
    ...
    -------------------------------------------- */
    Route::prefix('media-upload')->controller(\App\Http\Controllers\Landlord\Admin\MediaUploaderController::class)->group(function () {
        Route::post('/media-upload/all', 'all_upload_media_file')->name('tenant.user.upload.media.file.all');
        Route::post('/media-upload', 'upload_media_file')->name('tenant.user.upload.media.file');
        Route::post('/media-upload/loadmore', 'get_image_for_load_more')->name('tenant.user.upload.media.file.loadmore');
    });
