...
//        Route::post('/payment-settings','update_payment_settings');
 ...
 -------------------------------------------- */
    Route::controller(\App\Http\Controllers\Landlord\Admin\PaymentSettingsController::class)->prefix('payment-settings')->group(function (){
        ...
        Route::get('/paymob','paymob_settings')->name('landlord.admin.payment.paymob.settings');
        Route::get('/awdpay','awdpay_settings')->name('landlord.admin.payment.awdpay.settings');
        Route::get('/powertranzpay','powertranzpay_settings')->name('landlord.admin.payment.powertranzpay.settings');
        Route::get('/iyzipay','iyzipay_settings')->name('landlord.admin.payment.iyzipay.settings');
    ...
    Route::prefix('demo-data')->controller(SeederSettingsController::class)->group(function () {
      ...
      //====================== PRODUCT SEEDER ==========================
        ...
        Route::post('/tenant-demo-data-settings', 'update_tenant_demo_data_settings')->name('update.landlord.admin.seeder.demo.data.settings');
