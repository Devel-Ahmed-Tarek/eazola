...
class RoomBookingController extends Controller
{
    ...
    public function search_room(Request $request)
    {
       ...
       // pass all rooms, if search available pass filtered room
        ...
        return themeView(self::BASE_PATH.'room-search',compact('all_rooms','search_data','all_amenities','ratting','amenity_id'));
    }
    ...
    public function checkout(Request $request)
    {
       ...
       $inventories = BookingServices::get_inventories_by_date_range($booking_sell_info);
        ...
        if (!Auth::guard('web')->check())
        {
            ...
            return response()->json(['login_redirect_url' => "success"]);



//            return response()->json([
//                'type' => 'worning',
//                'warning_msg' => __('Please Login first to success your reservation'),
//            ]);
        }
