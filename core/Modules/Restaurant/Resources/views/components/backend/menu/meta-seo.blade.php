    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane py-4 fade show active general-meta-pane" id="general-meta-info" role="tabpanel" aria-labelledby="general-meta-info-tab">
            ...
            <div class="form-group dashboard-input">
                ...
                <input type="text" id="general-title" value=" {{ $metaData?->getTranslation('title',$defaultLang) }}" data-role="tagsinput" class="form--control radius-10 tags_input" name="general_title" placeholder="{{__("General info title")}}">
            </div>
            <div class="form-group">
                <label for="general-description">{{__("Description")}}</label>
                <textarea type="text" id="general-description" name="general_description" class="form--control radius-10 py-2" rows="6" placeholder="{{__("General info description")}}">{{ $metaData?->getTranslation('description',$defaultLang) }}</textarea>
            </div>
        </div>
