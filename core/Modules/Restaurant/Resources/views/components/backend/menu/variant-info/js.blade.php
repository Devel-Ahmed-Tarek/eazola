    ...
    (function ($) {
        ...
        $(document).ready(function () {
            $(document).on('click', '.add_variant_info_btn', function () {
                $(this).closest('.variant_info').append(`<x-restaurant::backend.menu.variant-info.repeater :is-first="false" :all-available-attributes="$allAttributes" />`);
            });
        ...
        $(document).on('click', '.repeater_button .add', function (e) {
            let inventory_item = `<x-restaurant::backend.menu.variant-info.repeater :all-available-attributes="$allAttributes" />`;
        ...
        $(document).on('click', '.repeater_button .remove', function (e) {
            ...
            let button_l = $('.repeater_button .remove').length;
