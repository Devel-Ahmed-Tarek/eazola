...
@section('title') {{__('All Order Reports')}} @endsection
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Order Reports')}}</h4>
    ...
    <script>
        ...
        (function($) {
            ...
            $(document).on("submit","#report-export",function(e)
            {
                ...
                $.ajax({
                    url: "{{ route('tenant.admin.menu.order.report.search') }}",
                    type: "POST",
                    data: {
                        _token : "{{csrf_token()}}",
                    ...
                    success:function (data){
                        if(data.warning_msg){
                            Swal.fire({
                                position: 'end-start',
                                icon: 'warning',
                                title: '{{ __("No Order available on this date range") }}',
