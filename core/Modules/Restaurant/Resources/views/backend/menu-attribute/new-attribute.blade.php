                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            @can('restaurant-menu-attribute-all')
                            <a href="{{route('tenant.admin.menu.attributes.all')}}" class="btn btn-primary">{{__('All Variants')}}</a>
                            @endcan
                        </div>

                        @can('restaurant-menu-attribute-create')
                        <form action="{{route('tenant.admin.menu.attributes.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
