                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <a href="{{route('tenant.admin.menu.attributes.all')}}" class="btn btn-primary">{{__('All Attributes')}}</a>
                            @endcan
                        </div>

                        @can('restaurant-menu-attribute-edit')
                        <form action="{{route('tenant.admin.menu.attributes.update')}}" method="post" enctype="multipart/form-data">
                            @csrf
