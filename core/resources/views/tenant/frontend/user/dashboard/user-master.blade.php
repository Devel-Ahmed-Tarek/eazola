                    ...
                    <div class="dashboard-close-main">
                        ...
                        <div class="dashboard-bottom margin-top-35 margin-bottom-50">
                            <ul class="dashboard-list ">
                                ...
                                <li class="list @if(request()->routeIs('tenant.user.dashboard.restaurant-order') || request()->routeIs('tenant.user.dashboard.user.order') || request()->routeIs('tenant.user.dashboard.canceled.order') || request()->routeIs('tenant.user.dashboard.pending.order') || request()->routeIs('tenant.user.dashboard.approved.order')) active @endif">
                                    <a href="{{route('tenant.user.dashboard.restaurant-order')}}"> <i class="las la-th"></i> {{__('Restaurant Orders')}} </a>
                                </li>
                                @endif
