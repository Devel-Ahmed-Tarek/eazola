...
@section('section')
    ...
    <div class="parent">
        ...
        <form action="{{route('tenant.user.profile.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                ...
                <div class="input-form input-form2 col-lg-6">
                ...
                <div class="input-form input-form2 col-lg-6 country_div">
                ...
                <x-fields.media-upload name="image" title="{{__('Image')}}" value="{{$user_details->image}}" id="{{$user_details->image}}"/>
    ...
    <x-media-upload.markup :user-type="'user'"/>
@endsection
