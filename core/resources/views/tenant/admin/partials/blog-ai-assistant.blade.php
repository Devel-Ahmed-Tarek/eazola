{{-- مساعد الذكاء الاصطناعي للمدونة: أزرار + نافذة (يتم استدعاء السكربت من قسم scripts في الصفحة) --}}
@php
    $aiAssistUrl = route(route_prefix().'admin.blog.ai.assist');
@endphp

<div class="alert alert-light border mb-3 blog-ai-toolbar">
    <div class="d-flex flex-wrap align-items-center gap-2">
        <span class="text-muted small fw-semibold">
            <i class="mdi mdi-lightbulb text-success"></i> {{ __('AI assistant') }}
        </span>
        <button type="button" class="btn btn-sm btn-outline-success blog-ai-open-modal" data-blog-ai-mode="generate">
            {{ __('Generate draft') }}
        </button>
        <button type="button" class="btn btn-sm btn-outline-primary blog-ai-open-modal" data-blog-ai-mode="refine">
...
<div class="modal fade" id="blogAiModal" tabindex="-1" aria-hidden="true" data-ai-url="{{ $aiAssistUrl }}" data-ai-lang="{{ $lang_slug }}">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="blogAiModalTitle">{{ __('AI blog assistant') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="blog-ai-panel-generate">
                ...
                <div id="blog-ai-panel-refine" class="d-none">
                ...
                <div id="blog-ai-error" class="alert alert-danger mt-3 d-none" role="alert"></div>
                <div id="blog-ai-loading" class="d-none text-center py-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="blog_ai_run_btn">
                    {{ __('Apply to editor') }}
                </button>
            </div>
        </div>
